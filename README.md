...
To train and test, you can modify the used original codes by yourself referring to the technical details mentioned in our manuscript. The used original codes are provided in the zip files --- [STANet](https://github.com/guotaowang/STANet), [STAViS](https://github.com/atsiami/STAViS) and [AViNet](https://github.com/samyak0210/ViNet).
